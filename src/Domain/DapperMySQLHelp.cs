...
namespace Domain
{
    public class DapperMySQLHelp
    {
        ...
        public DapperMySQLHelp()
        {
            this.connection = ConfigHelper.ReadConfigByName("DefaultConnection", "ConnectionStrings:");
        }
        ...
        {
            int result = 0;
            using (MySqlConnection con = new MySqlConnection(this.connection))
            {
                if (flag)
                {
